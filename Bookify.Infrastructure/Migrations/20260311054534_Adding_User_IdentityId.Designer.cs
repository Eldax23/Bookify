...
namespace Bookify.Infrastructure.Migrations
{
    ...
    [Migration("20260311054534_Adding_User_IdentityId")]
    partial class Adding_User_IdentityId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookify.Domain.Apartments.Apartment", b =>
                {
                    b.OwnsOne("Bookify.Domain.Shared.Records.Money", "CleaningFee", b1 =>
                        {
                    ...
                    b.OwnsOne("Bookify.Domain.Shared.Records.Money", "Price", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Bookify.Domain.Apartments.Records.Address", "Address", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Bookify.Domain.Bookings.Booking", b =>
                {
                    ...
                    b.OwnsOne("Bookify.Domain.Shared.Records.Money", "AmentiesFee", b1 =>
                        {
                            ...
                            b1.Property<decimal>("Amount")
                                .HasColumnType("numeric")
                                .HasColumnName("amenties_fee_amount");

                            b1.Property<string>("currency")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("amenties_fee_currency");
                    ...
                    b.OwnsOne("Bookify.Domain.Shared.Records.Money", "PriceForPeriod", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Bookify.Domain.Shared.Records.Money", "TotalPrice", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
